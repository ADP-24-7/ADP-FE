...
기준은 2026-09-09 `ADP-BE origin/main@d937f64`와 Notion `개발단계 추적`이다.
...
| BE-9 Recovery Operations | Runtime · Recovery | Incident 목록/상세, reconcile/safe retry/manual review 명령 연결 |
...
| BE-11 Observability | 통합 관제, Monitoring | scoped Operations Summary와 Policy Event History 연결 |
